...
if (type.equals("index")) {
      ...
      out.write("\n");
      out.write("<section>\r\n");
      out.write("\t\t<h4>Please enter the information below to register for the application</h4>\r\n");
      out.write("\t\t");
 if (request.getAttribute("error_message") == null) {
      out.write("\r\n");
      out.write("\t\t<p class=\"required\" id=\"error\">* is required field</p>\r\n");
      out.write("\t\t");
}else{ 
      out.write("\r\n");
      out.write("\t\t<p class=\"required\" id=\"error\">");
      out.print( request.getAttribute("error_message") );
      out.write("</p>\r\n");
      out.write("\t\t");
} 
      out.write("\r\n");
      out.write("\t\t<form id = \"form\" method=\"post\" action = \"/jsp/CreateUser\">\r\n");
      out.write("\t\t\t<p>\r\n");
      ...
      out.write("\t\t\t<input id = \"password1\" name = \"password\" type = \"password\" required placeholder = \"the length is at least 6 chars\" pattern = \"^[A-Za-z0-9]{6,}$\" />\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t<label for=\"password2\">*Password: </label>\r\n");
      out.write("\t\t\t<input id = \"password2\" type = \"password\" required placeholder = \"reenter your password\" pattern = \"^[A-Za-z0-9]{6,}$\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t<label for=\"email\">Email: </label>\r\n");
      out.write("\t\t\t<input id = \"email\" name = \"email\" type = \"email\" placeholder = \"email address\" pattern = \"^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.(com|org|net|edu|gov|mil|biz|info|mobi|name|aero|asia|jobs|museum)$\"/>\r\n");
      out.write("\t\t\t<p><br />\r\n");
      out.write("\t\t\t<input type = \"submit\" id = \"submit\" name = \"submit\" value = \"register\" />\r\n");
      out.write("\t\t</form>\r\n");
      out.write("</section>\r\n");
      out.write("<footer>\r\n");
